...
function Game() {
  ...
  // inline style in the H1 tag, line 67
  // The remaining styles using styles.<element> are from the module stylesheet, Game.module.css
  return (
